...
ISEStep( "vivado",
         "-log Lab5_TeamX_Sliding_Window_Sequence_Detector_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab5_TeamX_Sliding_Window_Sequence_Detector_tb.tcl" );
