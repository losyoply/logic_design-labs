...
HD_PWD='C:/Users/losyo/Desktop/verilog/Lab4/FPGA/FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_1A2B.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPGA_1A2B.tcl -notrace
