...
HD_PWD='C:/Users/losyo/Desktop/verilog/Lab4/FPGA/FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_1A2B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_1A2B.tcl
